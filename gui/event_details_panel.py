...
class EventDetailsPanel(ttk.Frame):
    ...
    def __init__(self, parent, app_coordinator):
        ...
        details_frame.pack(fill=tk.X, expand=False, pady=10, padx=10)
    ...
    def display_event_details(self, event):
        ...
        self.history_boost_var.set(f"History Boost Applied: +{boost_val:.1f}%")
    ...
    def clear_details(self):
        ...
        self.interest_score_var.set("Interest Match (Base): N/A")
        ...
        self.history_boost_var.set("History Boost Applied: N/A")
    ...
    def _draw_score_visualization(self, score):
        ...
        bar_width = max(0, min(canvas_width, bar_width))
