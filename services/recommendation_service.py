...
class RecommendationService:
    ...
    def __init__(self):
        ...
        self.events = self._load_sample_events()
        self.load_sample_time_ranges()
    ...
    def load_sample_time_ranges(self):
        ...
        # Add the time range to the user preferences
        self.update_time_preferences([(start_time, end_time)])
    ...
    def get_recommended_events(self, sort_key="Recommendation", search_term=None):
        ...
        for event in self.events:
            ...
            interest_score, history_boost = self._calculate_interest_match_score(event)
            ...
            event.scores_breakdown = {
                ...
                "interest_match_boosted": interest_score_boosted,
